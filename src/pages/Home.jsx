...
const Home = () => {
  return (
    <div className="bg-gray-900">
      <section className="px-2 py-32 bg-gray-900 md:px-0">
            ...
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                  ...
                  <br />
                  <span className="block text-indigo-400 xl:inline">Your Support Hub for All Issues.</span>
                </h1>
      ...
      <section className="px-2 py-16 bg-gray-800">
        <div className="container items-center max-w-6xl px-8 mx-auto xl:px-5">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center group">
              ...
              <h3 className="mt-4 text-xl font-semibold text-white group-hover:text-purple-400 transition-all duration-300 ease-in-out">Voting System</h3>
              <p className="mt-2 text-gray-300 text-center group-hover:text-gray-100 transition-all duration-300 ease-in-out">A comprehensive voting system that enables you to find the most preferred answers to your challenges.</p>
            </div>
            ...
            <div className="flex flex-col items-center group">
              ...
              <h3 className="mt-4 text-xl font-semibold text-white group-hover:text-purple-400 transition-all duration-300 ease-in-out">Real-Time Support</h3>
              <p className="mt-2 text-gray-300 text-center group-hover:text-gray-100 transition-all duration-300 ease-in-out">Offer real-time support through chat and quick responses to customer inquiries.</p>
            </div>
            ...
            <div className="flex flex-col items-center group">
              ...
              <h3 className="mt-4 text-xl font-semibold text-white group-hover:text-purple-400 transition-all duration-300 ease-in-out">Knowledge Base</h3>
              <p className="mt-2 text-gray-300 text-center group-hover:text-gray-100 transition-all duration-300 ease-in-out">Access a comprehensive knowledge base for customers to find solutions to common issues quickly.</p>
            </div>
          </div>
        </div>
      </section>
